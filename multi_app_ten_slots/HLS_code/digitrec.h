...
//void DigitRec(WholeDigitType global_training_set[NUM_TRAINING], WholeDigitType global_test_set[NUM_TEST], LabelType global_results[NUM_TEST]);
void DigitRec(const DigitType global_training_set[NUM_TRAINING], const DigitType global_test_set[NUM_TEST], LabelType global_results[NUM_TEST]);
